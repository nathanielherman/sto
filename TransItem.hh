...
class TransProxy {
  public:
    ...
    inline TransProxy& observe(TVersion version, bool remember);
    inline TransProxy& observe(TNonopaqueVersion version, bool remember);
    inline TransProxy& observe(TCommutativeVersion version, bool remember);
